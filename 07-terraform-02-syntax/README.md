...
```shell
dmitry@dmitry-N56VZ:~/PycharmProjects/terraform-netology$ terraform plan
...
Terraform will perform the following actions:
  ...
  # yandex_compute_instance.ubuntu will be created
...
2. Ссылку на репозиторий с исходной конфигурацией терраформа.   
      ...
      https://github.com/kuzmich84/terraform-netology
